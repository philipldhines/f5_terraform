...
echo "INT3ADDRESS=$(curl -s -f --retry 10 "$${COMPUTE_BASE_URL}/instance/network-interfaces/3/ip" -H 'Metadata-Flavor: Google')" >> /config/cloud/interface.config
echo "INT3MASK=$(curl -s -f --retry 10 "$${COMPUTE_BASE_URL}/instance/network-interfaces/3/subnetmask" -H 'Metadata-Flavor: Google')" >> /config/cloud/interface.config
echo "INT3GATEWAY=$(curl -s -f --retry 10 "$${COMPUTE_BASE_URL}/instance/network-interfaces/3/gateway" -H 'Metadata-Flavor: Google')" >> /config/cloud/interface.config
echo "INT4ADDRESS=$(curl -s -f --retry 10 "$${COMPUTE_BASE_URL}/instance/network-interfaces/4/ip" -H 'Metadata-Flavor: Google')" >> /config/cloud/interface.config
echo "INT4MASK=$(curl -s -f --retry 10 "$${COMPUTE_BASE_URL}/instance/network-interfaces/4/subnetmask" -H 'Metadata-Flavor: Google')" >> /config/cloud/interface.config
echo "INT4GATEWAY=$(curl -s -f --retry 10 "$${COMPUTE_BASE_URL}/instance/network-interfaces/4/gateway" -H 'Metadata-Flavor: Google')" >> /config/cloud/interface.config
...
echo "INT3NETWORK=$INT3NETWORK" >> /config/cloud/interface.config
echo "INT4NETWORK=$INT4NETWORK" >> /config/cloud/interface.config
...
"tmsh create net self self_internal2 address $${INT3ADDRESS}/32 vlan internal2"
...
"tmsh create net self self_internal3 address $${INT4ADDRESS}/32 vlan internal3"
