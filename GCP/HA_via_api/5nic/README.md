...
| <a name="input_int2Subnet"></a> [int2Subnet](#input\_int2Subnet) | Internal subnet 2 | `string` | `null` | no |
| <a name="input_int2Vpc"></a> [int2Vpc](#input\_int2Vpc) | Internal VPC network 2 | `string` | `null` | no |
| <a name="input_int3Subnet"></a> [int3Subnet](#input\_int3Subnet) | Internal subnet 3 | `string` | `null` | no |
| <a name="input_int3Vpc"></a> [int3Vpc](#input\_int3Vpc) | Internal VPC network 3 | `string` | `null` | no |
...
To run this Terraform template, perform the following steps:
  ...
  ```
      ...
      int2Vpc       = "xxxxx-net-int2"
      int3Vpc       = "xxxxx-net-int3"
      mgmtSubnet   = "xxxxx-subnet-mgmt"
      extSubnet    = "xxxxx-subnet-ext"
      intSubnet    = "xxxxx-subnet-int"
      int2Subnet    = "xxxxx-subnet-int2"
      int3Subnet    = "xxxxx-subnet-int3"
