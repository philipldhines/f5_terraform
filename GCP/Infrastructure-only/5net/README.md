# Deploying Infrastructure-Only in Google GCP - 5 VPCs/Networks/Subnets
...
| [google_compute_firewall.default-allow-internal-int2](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_firewall) | resource |
| [google_compute_firewall.default-allow-internal-int3](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_firewall) | resource |
...
| [google_compute_network.vpc_int2](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_network) | resource |
| [google_compute_network.vpc_int3](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_network) | resource |
...
| [google_compute_subnetwork.vpc_int2_sub](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_subnetwork) | resource |
| [google_compute_subnetwork.vpc_int3_sub](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_subnetwork) | resource |
...
| <a name="input_cidr_range_int2"></a> [cidr\_range\_int2](#input\_cidr\_range\_int2) | IP CIDR range for internal VPC network | `string` | `"10.1.30.0/24"` | no |
| <a name="input_cidr_range_int3"></a> [cidr\_range\_int3](#input\_cidr\_range\_int3) | IP CIDR range for internal VPC network | `string` | `"10.1.40.0/24"` | no |
...
| <a name="output_internal_subnet2"></a> [internal\_subnet2](#output\_internal\_subnet2) | Internal subnet2 name |
| <a name="output_internal_subnet3"></a> [internal\_subnet3](#output\_internal\_subnet3) | Internal subnet3 name |
| <a name="output_internal_vpc"></a> [internal\_vpc](#output\_internal\_vpc) | Internal VPC name |
| <a name="output_internal_vpc2"></a> [internal\_vpc2](#output\_internal\_vpc2) | Internal VPC2 name |
| <a name="output_internal_vpc3"></a> [internal\_vpc3](#output\_internal\_vpc3) | Internal VPC3 name |
